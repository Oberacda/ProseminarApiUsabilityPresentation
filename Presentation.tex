...
\section{Motivation}
	...
	\begin{frame}{APIs \& Benutzbarkeit}
...
\section{Resultate}
	...
	\begin{frame}{Bearbeitungszeit nach Constructor}
		\begin{figure}
			\includegraphics[scale=0.35]{graphics/box_time-constructor.png}
			\caption{\label{fig:box_time-constructor.png} Die prozentuale Verteilung der Bearbeitungszeit auf verschiedene Areas of Interest (AOI)}
		\end{figure}
	\end{frame}
